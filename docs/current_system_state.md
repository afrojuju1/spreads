...
`DataEngine -> engine facts/read models -> StrategyEngine -> AllocationPlan -> Protection/RiskEngine -> PortfolioEngine -> ExecutionEngine -> Ops projections`.
