...
- [dolthub_earnings_calendar.py](../../packages/core/integrations/calendar_events/adapters/dolthub_earnings_calendar.py)
- [macro_calendar.py](../../packages/core/integrations/calendar_events/adapters/macro_calendar.py)
- [alpaca_corporate_actions.py](../../packages/core/integrations/calendar_events/adapters/alpaca_corporate_actions.py)
...
- [dolthub_earnings_calendar.py](../../packages/core/integrations/calendar_events/adapters/dolthub_earnings_calendar.py) uses a low-confidence DoltHub earnings source
