...
def _candidate_strategy_metrics(candidate: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "secondary_short_symbol": candidate.get("secondary_short_symbol"),
        "secondary_long_symbol": candidate.get("secondary_long_symbol"),
        "secondary_short_strike": candidate.get("secondary_short_strike"),
        "secondary_long_strike": candidate.get("secondary_long_strike"),
