...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "RunHistoryRepository": (".run_history_repository", "RunHistoryRepository"),
    ...
    "build_event_repository": (".factory", "build_event_repository"),
    "build_execution_repository": (".factory", "build_execution_repository"),
    "build_history_store": (".factory", "build_history_store"),
