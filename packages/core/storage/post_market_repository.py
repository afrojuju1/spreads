...
from core.storage.post_market_models import PostMarketAnalysisRunModel
from core.storage.records import PostMarketAnalysisRunRecord
from core.storage.serializers import parse_date, parse_datetime


class PostMarketAnalysisRepository(RepositoryBase):
    def schema_ready(self) -> bool:
        return self.schema_has_tables("post_market_analysis_runs")
