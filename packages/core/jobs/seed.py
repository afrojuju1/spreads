...
from core.services.bots import build_collector_scopes, load_active_bots
...
def default_job_definitions() -> list[dict[str, object]]:
    definitions = [
        {
...
def seed_definitions(db: str) -> list[str]:
    ...
    try:
        ...
        definitions = default_job_definitions()
        for definition in definitions:
