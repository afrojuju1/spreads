...
def build_jobs_overview(
    *,
    ...
    workflow_runtime = _project_workflow_runtime(
        ...
        correlated_queued_jobs=queued_run_rows,
    ...
    return {
        ...
        "summary": {
            ...
            "workflow_execution_status": workflow_runtime.execution_health_payload.get("status"),
            "open_workflow_execution_count": workflow_runtime.execution_health_payload.get("open_execution_count", 0),
            "workflow_execution_issue_count": len(workflow_runtime.execution_health_payload.get("issues") or []),
            "workflow_projection_mismatch_count": workflow_runtime.execution_health_payload.get("projection_mismatch_count", 0),
        ...
        "details": {
            ...
            "workflow_executions": workflow_runtime.execution_health_payload,
            "disabled_workflow_lanes": disabled_lane_rows,
