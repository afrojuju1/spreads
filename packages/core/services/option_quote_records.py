    ...
    for candidate in candidates:
        ...
        if contract_symbol:
            ...
            metadata[contract_symbol] = {
                ...
                "open_interest_date": candidate.get("open_interest_date"),
                ...
                "gamma": _coerce_float(candidate.get("gamma")),
                "vega": _coerce_float(candidate.get("vega")),
                "rho": _coerce_float(candidate.get("rho")),
        ...
        if normalized_legs:
            for leg in normalized_legs:
                ...
                metadata[option_symbol] = {
                    ...
                    "rho": _coerce_float(candidate.get(f"{role}_rho")),
        ...
        for leg_role_name, option_symbol in (
            ...
            metadata[option_symbol] = {
                ...
                "open_interest_date": _leg_value(candidate, leg_role=leg_role_name, key="open_interest_date"),
                ...
                "gamma": _coerce_float(_leg_value(candidate, leg_role=leg_role_name, key="gamma")),
                "vega": _coerce_float(_leg_value(candidate, leg_role=leg_role_name, key="vega")),
                "rho": _coerce_float(_leg_value(candidate, leg_role=leg_role_name, key="rho")),
