...
from core.services.research_thesis.contracts import ResearchRun
...
class ResearchArtifactStore:
    ...
    def append_log(self, run: ResearchRun, event: str, payload: dict[str, Any]) -> None:
